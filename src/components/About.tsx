      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid lg:grid-cols-[1.2fr_0.8fr] gap-10 items-start max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-base md:text-lg">
              Nossa estrutura permite fornecer serviços ágeis, reduzindo o tempo de indisponibilidade do veiculo ao cliente final. Trabalhamos com veículos <b>Híbridos</b> e <b>Elétricos</b>. Com foco no cliente, buscamos estar sempre atualizados nas novas tecnologias e qualificações dos nossos colaboradores, para garantir a qualidade no serviço prestado, de forma rápida e segura.
            </p>
          </motion.div>
